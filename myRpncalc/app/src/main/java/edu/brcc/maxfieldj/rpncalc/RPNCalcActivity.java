...
public class RPNCalcActivity extends AppCompatActivity {
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      for(final int  assignIdsToButtons : IDS_BUTTONS){
        ...
        //got to figure this part out since it displays when rotated but not the right input.
         if(savedInstanceState != null) {
         savedInstanceState.getIntArray(buttons.toString());
         mDisplay.setText(helper.addKey(buttons.toString()));
   ...
   protected void onSaveInstanceState(Bundle outState) {
      ...
      outState.getIntArray(buttons.toString());
   }
